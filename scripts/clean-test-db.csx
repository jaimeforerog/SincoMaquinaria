...
const string PostgresConnectionString = "host=localhost;database=postgres;password=postgres;username=postgres";

Console.WriteLine("Cleaning test database...");
...
try
{
    ...
    Console.WriteLine("✓ Test database cleaned successfully!");
}
catch (Exception ex)
{
